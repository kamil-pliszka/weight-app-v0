package com.pl.myweightapp.data.backuo
...
class BackupManager @Inject constructor(
    ...
    companion object {
        private const val TAG = "WeightBackupManager"
    }
...
//    }
     ...
     */
    suspend fun tryToRestoreBackup(): String = withContext(Dispatchers.IO) {
    ...
    suspend fun isAvailableRestore(): Boolean = withContext(Dispatchers.IO) {
